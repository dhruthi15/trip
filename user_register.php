...
$result1 = mysqli_query($conn,"SELECT * FROM login WHERE email = '$get_email'");
...
else
{
	...
	$result = mysqli_query($conn,"INSERT INTO login (name, email, password, mobile,field_1,field_2,field_3,field_4, status, created_date)
